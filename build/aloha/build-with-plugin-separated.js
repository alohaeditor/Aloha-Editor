...
({
  ...
  dir: "../../target/build-with-plugin-separated",
  ...
  paths: {
    ...
    'jquery-layout': 'vendor/jquery.layout-1.3.0-rc29.1', // Mutates jquery
  ...
  modules: [
    ...
    {
      name: 'undo/undo-plugin',
      exclude: ['aloha', 'ui/ui-plugin']
    },
    {
      name: 'captioned-image/captioned-image-plugin',
      exclude: ['aloha', 'ui/ui-plugin', 'block/block-plugin']
    },
    {
    ...
    //{
    //  name: 'attributes/attributes-plugin',
    //  exclude: ['aloha', 'ui/ui-plugin']
    //},
    {
      name: 'cite/cite-plugin',
      exclude: ['aloha', 'ui/ui-plugin', 'format/format-plugin']
    },
    //{
    //  name: 'comments/comments-plugin',
    //  exclude: ['aloha', 'ui/ui-plugin']
    //},
    //{
    //  name: 'draganddropfiles/draganddropfiles-plugin',
    //  include: [
    ...
    //{
    //  name: 'googletranslate/googletranslate-plugin',
    //  exclude: ['aloha', 'ui/ui-plugin']
    //},
    //{
    //  name: 'headerids/headerids-plugin',
    //  exclude: ['aloha', 'ui/ui-plugin']
    //},
    //{
    //  name: 'hints/hints-plugin',
    //  exclude: ['aloha', 'ui/ui-plugin']
    //},
    {
      name: 'imagebrowser/imagebrowser-plugin',
      exclude: ['aloha', 'ui/ui-plugin', 'image/image-plugin']
    },
    {
      name: 'linkbrowser/linkbrowser-plugin',
      exclude: ['aloha', 'ui/ui-plugin', 'link/link-plugin']
    },
    //{
    //  name: 'linkchecker/linkchecker-plugin',
    //  exclude: ['aloha', 'ui/ui-plugin']
    //},
    //{
    //  name: 'listenforcer/listenforcer-plugin',
    //  exclude: ['aloha', 'ui/ui-plugin']
    //},
    //{
    //  name: 'metaview/metaview-plugin',
    //  exclude: ['aloha', 'ui/ui-plugin']
    //},
    {
      name: 'numerated-headers/numerated-headers-plugin',
      exclude: ['aloha', 'ui/ui-plugin']
    },
    //{
    //  name: 'profiler/profiler-plugin',
    //  exclude: ['aloha', 'ui/ui-plugin']
    //},
    //{
  ...
  //fileExclusionRegExp: /speak|vie/i,
