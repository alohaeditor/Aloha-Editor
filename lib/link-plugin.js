...
define(
['i18n!link/nls/i18n', 'i18n!core/nls/i18n', 'css!link/css/link.css'],
function(i18n, i18nCore) {
	...
	return new (Aloha.Plugin.extend({
				...
				editable.obj.keydown(function (e) {
					if ( e.metaKey && e.which == 76 ) {
						if ( that.findLinkMarkup() ) {
							Aloha.FloatingMenu.userActivatedTab = i18n.t('floatingmenu.tab.link');
