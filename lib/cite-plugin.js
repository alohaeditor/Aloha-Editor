	...
	return Plugin.create('cite', {
		...
		addBlockQuote: function () {
			var classes = [nsClass('wrapper'), nsClass(++uid)].join(' '),
				markup = $('<blockquote class="{classes}" data-cite-id="{uid}"></blockquote>'.supplant({uid:uid, classes:classes}));
		...
		addInlineQuote: function () {
			var classes = [nsClass('wrapper'), nsClass(++uid)].join(' '),
				markup = $('<q class="{classes}" data-cite-id="{uid}"></q>'.supplant({uid:uid, classes:classes})),
