...
define(
['i18n!table/nls/i18n', 'i18n!core/nls/i18n', 'css!table/css/table.css'],
function(i18n, i18nCore) {
	var
	 ...
	 */
	var TablePlugin = new Aloha.Plugin('table');
		...
		Aloha.bind('aloha-selection-changed', function(event, rangeObject) {
			...
			if (Aloha.activeEditable) {
				...
				if ( table ) {
					...
					Aloha.FloatingMenu.setScope(that.getUID(TableHelper.selectionType));
				} else {
					if ( that.activeTable ) {
	...
	***************************/
	 ...
	 */
	Table.prototype.obj = undefined;

	/**
	 * The DOM-element of the outest div-container wrapped around the cell
	 */
	Table.prototype.tableWrapper = undefined;
	 ...
	 * @see Table.Cell
	 */
	Table.prototype.cells = undefined;
	...
	//				jQuery(firstCell).get(0).focus();
					...
					Aloha.FloatingMenu.userActivatedTab = i18n.t('floatingmenu.tab.table');
					Aloha.FloatingMenu.doLayout();
	...
	******************************/
	...
	//		Aloha.FloatingMenu.setScope(TablePlugin.getUID('cell'));
