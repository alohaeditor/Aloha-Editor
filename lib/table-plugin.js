...
function(Plugin, PluginManager, FloatingMenu, i18n, i18nCore) {
  ...
  */
  TablePlugin.checkConfig = function (c){
    ...
    //   c[i].iconClass = c[i].iconClass ? c[i].iconClass : 'aloha-button-' + c[i].name;
  ...
  TablePlugin.initRowsBtns = function () {
    ...
    FloatingMenu.addButton(
      this.getUID('row'),
      this.rowHeader,
      i18n.t(this, 'floatingmenu.tab.table'),
      1
    );
    ...
    jQuery.each(this.rowConfig, function (j, itemConf) {
      that.rowMSItems.push({
        name: itemConf.name,
        text: i18n.t(that, itemConf.text),
        tooltip: i18n.t(that, itemConf.tooltip),
  ...
  TablePlugin.initColumnBtns = function () {
    ...
    if(this.tableMSItems.length > 0) {
      FloatingMenu.addButton(
        this.getUID('cell'),
        this.tableMSButton,
        i18n.t(this, 'floatingmenu.tab.tablelayout'),
        3
      );
    };
