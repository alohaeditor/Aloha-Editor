...
function(Plugin, i18n, i18nCore) {
  ...
  return Plugin.create('table', {
     ...
     */
    isEditableTable: function (table) {
    ...
    /* Check whether this method works and make it compatible with method in dev-requirejs - LP */

    initRowsBtns: function () {
      var that = this,
     ...
     */
    makeCaptionEditable: function(caption, captionText) {
      var that = this;
     ...
     */
    createDialog: function(callingElement) {
    ...
    setFocusedTable: function(focusTable) {
      var that = this;
