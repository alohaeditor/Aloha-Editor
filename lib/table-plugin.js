...
//            for (var j = 0; j < sc[i].length; j++) {
              ...
              if (this.isPressed()) {
                ...
                sc[i] = Aloha.Markup.transformDomObject(sc[i], 'th').attr('scope', that.name + '.col')[0];
              }
...
//            }
          ...
          for (var i = 0; i < sc.length; i++) {
            for (var j = 0; j < sc[i].length; j++) {
              ...
              if (this.isPressed()) {
                ...
                sc[i][j] = Aloha.Markup.transformDomObject(sc[i][j], 'th').attr('scope', that.name + '.row');
              }
  ...
  Table.prototype.selectColumns = function () {
    ...
    FloatingMenu.setScope(this.name + '.column');
        ...
        if ( j == 0 && i == 0 && cell ) {
          ...
          TablePlugin.columnHeader.setPressed(
            cell.nodeName.toLowerCase() == 'th'
              &&
            jQuery(cell).attr('scope') == this.name + '.row'
          );
  ...
  Table.prototype.selectRows = function () {
      ...
      if (i == 0) {
        ...
        TablePlugin.rowHeader.setPressed(
          rowCells[1].nodeName.toLowerCase() == 'th'
            &&
          jQuery(rowCells[1]).attr('scope') == this.name + '.col'
        );
    ...
    FloatingMenu.setScope(this.name + '.row');
