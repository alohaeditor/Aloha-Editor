  ...
  */
  ...
  Table.Cell.prototype.selectCellRange = function(){
    ...
    for(var k=0; k < current_selection_range.length; k++){
      ...
      console.log(current_selection_range[k]);
      console.log(cell_to_select);
      console.log(index_of_selected_cell);
      ...
      jQuery.each(this.selectedCells, function(){
        ...
        if(colspan > 1){
          for(var i = 0; i < (colspan - 1); i++){
            cur_cell.after('<td>'); 
            activate_new_cell(cur_cell.next()); 
          } 
        ...
        if(rowspan > 1){
          ...
          for(var i = 0; i < (rowspan - 1); i++){
            //TODO: support colspans after rowspan
            var cell_below = jQuery(jQuery(rows_after_current[i]).children('td')[cur_cell_x]);
            cell_below.before('<td>');
            activate_new_cell(cell_below.prev()); 
          } 
        }
