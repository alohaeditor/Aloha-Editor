...
define(
['aloha/plugin', 'paste/genericpastehandler', 'paste/oembedpastehandler', 'paste/wordpastehandler'],
function(Plugin, GenericPasteHandler, OEmbedPasteHandler, WordPasteHandler) {
	"use strict";
	...
	return Plugin.create('paste', {
		 ...
		 */
		getPastedContent: function(event) {
			var that = this,
