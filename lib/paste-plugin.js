...
define(
['aloha/core', 'aloha/plugin', 'aloha/jquery', 'aloha/commands', 'paste/genericpastehandler', 'paste/oembedpastehandler',
 'paste/wordpastehandler'],
function(Aloha, Plugin, jQuery, Commands, GenericPasteHandler, OEmbedPasteHandler,
		WordPasteHandler) {
	"use strict";
	...
	function getPastedContent() {
		...
		if (pasteRange && pasteEditable) {
			...
			pasteDivContents = $pasteDiv.contents();
