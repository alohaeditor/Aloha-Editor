...
define(
['paste/genericpastehandler', 'paste/oembedpastehandler', 'paste/wordpastehandler'],
function(GenericPasteHandler, OEmbedPasteHandler, WordPasteHandler) {
	"use strict";
	 ...
	 */
	var PastePlugin = new Aloha.Plugin('paste');

	/**
	 * All registered paste handlers
	 */
	PastePlugin.pasteHandlers = [];

	/**
	 * Initialize the PastePlugin
	 */
	PastePlugin.init = function() {
		var that = this;
	 ...
	 */
	PastePlugin.redirectPaste = function() {
	 ...
	 */
	PastePlugin.getPastedContent = function(event) {
		var that = this,
	 ...
	 */
	PastePlugin.pasteElement = function(object) {
	 ...
	 */
	PastePlugin.register = function(pasteHandler) {
		this.pasteHandlers.push(pasteHandler);
	};

	PastePlugin.register(new GenericPasteHandler());
	PastePlugin.register(new OEmbedPasteHandler());
	PastePlugin.register(new WordPasteHandler());
