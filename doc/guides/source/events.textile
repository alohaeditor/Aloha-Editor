...
<javascript>
Aloha.on('event-name', function (jQuery.Event, eventArgument) {});
...
define(['PubSub'], function (PubSub) {
    ...
    PubSub.pub('event.name', {key: value});
});
</javascript>
...
<script type="text/javascript">
   ...
   Aloha.ready( function(){
       Aloha.on( 'aloha-editable-created', function( jEvent, editable ) {
           console.log( 'editable "' + editable.getId() + '" created' );
       });
       Aloha.on( 'aloha-editable-destroyed', function( jEvent, editable ) {
           console.log( 'editable "' + editable.getId() + '" destroyed' );
       });
       Aloha.on( 'aloha-editable-deactivated', function( jEvent, aEvent ) {
           console.log( 'editable "' + aEvent.editable.getId() + '" deactivated' );
       });
       Aloha.on( 'aloha-editable-activated', function( jEvent, aEvent){
...
h4. aloha.drop.block.in.editable Event

Is published when a draggable block is dropped into an editable part.

<javascript>
PubSub.pub('aloha.drop.block.in.editable', {
  element   : , // object of dropped block
  editable  : , // object of target editable
});
</javascript>