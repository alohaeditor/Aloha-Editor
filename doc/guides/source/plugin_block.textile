...
If a block is placed inside an editable, it can be drag/drop by default. If you want to prevent drag/drop behaviour for all blocks, add the following configuration option:
