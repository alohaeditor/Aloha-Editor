...
h4. Underline and Strikethrough

Texts or headlines can be underlined or have strikethrough applied as well. Just selecting the text or headline and click on the underline or strikethrough button at the Aloha Editor. This wrap the selected text or headline into a +<u>+ tag if underlined or +<del>+ tag if strikethrough is chosen.
To undo this select the text or headline and click the button again.
