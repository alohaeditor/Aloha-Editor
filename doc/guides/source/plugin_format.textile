...
The following components can be added to the toolbar-settings (on default, all are provided):

* @code@ - format content as a code block
* @emphasize@ - emphasize content
* @italic@ - format content italic
* @strong@ - put strong emphasis on content
...
* @deleted@ - marks text as deleted
* @inserted@ - marks text as inserted
* @typographyMenu@ - will allow you to add typography formattings (h1, h2, h3, h4, h5, h6, p, pre)
...
Note that the @config@ uses the @HTML@ node-names to determine which elements are allowed,
instead of the component names.
