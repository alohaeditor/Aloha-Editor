...
Aloha woul load itself, which should be the most recent version of
jQuery. Older versions may work, but since older versions are not tested
against.

If you don't use the jQuery provided with Aloha, please expect for
things to break.

Please also note that the given jQuery will be extended with many jQuery
plugins.
