...
<html>
<head>
	<script src="javascripts/aloha.js" data-aloha-plugins="common/format"></script>
</head>
</html>
...
<script type="text/javascript">
	requireAloha( function( Aloha ) {
		...
		// Make #content editable once Aloha is loaded.
		// .aloha() will wait until Aloha is ready and then fire
...
* +Aloha+ the core Aloha Editor object which gives you access to the main functionallity
* +GENTICS+ the utilities to manipulate the DOM in a proper way
* +alohaQuery+  the Aloha Editor enabled jQuery which provides commodity access to Aloha Editor features
...
As an alternative you may specify jQuery in the settings
