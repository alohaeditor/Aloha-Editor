...
Maybe you want to start testing Aloha Editor in your browser. The easiest way to start are prefereably the demos. 
...
Afterwards the demos should be reachable under http://localhost/Aloha-Editor/src/demo/
