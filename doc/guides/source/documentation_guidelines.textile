...
Guides are written using a ruby gem called @guides@. You need the following tools to get started:

* Ruby and Rubygems (If you have the @gem@ command available, chances are good that everything works flawlessly)
