...
NOTE: If you are using a textarea with Aloha Editor and the textarea has a HTML ID (eg. mytxtarea) the Aloha Editor ID of the editable will be suffixed with "-aloha" (eg. mytxtarea-aloha).
