...
Now in plugin2 you can define a dependency on +plugin1/module+ from plugin1 and extend the module with our own function when plugin2 is loaded. If another plugin would require +plugin1/module+ it would have our extended funcitonality. 

<javascript filename="plugin2/lib/plugin2-plugin.js">
define(
[ 'aloha/plugin', 'plugin1/module' ],
