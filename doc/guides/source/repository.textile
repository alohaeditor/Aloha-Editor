...
Does a full text search in all attributes and properties which have '''fulltextIndexed == true’’’.
This differs from the CMIS spec because we do not support a query language and do always a full text search.
