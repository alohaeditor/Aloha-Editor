...
NOTE: The names used in +tableConfig+, +columnConfig+, +rowConfig+ and +cellConfig+ must be unique.
...
Aloha.settings.plugins: {
	table: {
		...
		tableConfig : [
			{ name: 'table-style-minimalist' icon: 'border_clear', iconHollow: false, label: 'Minimalist'},
			{ name: 'table-style-box', icon: 'border_all', iconHollow: false, label: 'Box' },
			{ name: 'table-style-zebra', icon: 'table_rows_narrow', iconHollow: false, label: 'Zebra' },
		],
		...
		// - label:      the label to display in the dropdown
		columnConfig : [
				{ name: 'column-style-align-left',  icon: 'format_align_left', iconHollow: false, label: 'Align left' },
				{ name: 'column-style-align-right', icon: 'format_align_right', iconHollow: false, label: 'Align right' }
		],
		rowConfig : [
				{ name: 'row-style-align-left',  icon: 'format_align_left', iconHollow: false, label: 'Align left' },
				{ name: 'row-style-align-right', icon: 'format_align_right', iconHollow: false, label: 'Align right' }
		],
		cellConfig : [
				{ name: 'cell-style-align-left',  icon: 'format_align_left', iconHollow: false, label: 'Align left' },
				{ name: 'cell-style-align-right', icon: 'format_align_right', iconHollow: false, label: 'Align right' }
		],
		// allow resizing the table width (options: "px", false, default: false)
		tableResize: true,
		// allow resizing the column width. (options: "px", "%",  false, default: false)
