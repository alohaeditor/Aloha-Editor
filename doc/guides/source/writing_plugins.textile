...
h4. Setting the current language

You can use the following setting to switch the current language of Aloha Editor:
...
As requirejs is used for localization you might want to check out "their documentation":http://requirejs.org/docs/api.html#i18n on i18n bundles and fallbacks.
