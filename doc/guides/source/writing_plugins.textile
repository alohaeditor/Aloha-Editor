...
WARNING: Add paragraph about subclassing "Greeter".

We also support mixins by specifying multiple arguments to @Class.extend@. For example, in order to make your class observable, you can mix in @core/observable@:
