...
h3. DOM to XHTML Plugin

This plugin provides support for XHTML serialization. This plugin doesn't provide configuration settings. See the "plugin page":plugin_dom_to_xhtml.html for more information.
