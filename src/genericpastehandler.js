...
(function(window, undefined) {
	 ...
	 */
	Aloha.PastePlugin.GenericPasteHandler = new Aloha.PastePlugin.PasteHandler();

	/**
	 * Handle the pasting. Remove all unwanted stuff.
	 * @param jqPasteDiv
	 */
	Aloha.PastePlugin.GenericPasteHandler.handlePaste = function(jqPasteDiv) {
		// transform tables
	 ...
	 * @param jqPasteDiv
	 */
	Aloha.PastePlugin.GenericPasteHandler.transformTables = function(jqPasteDiv) {
	 ...
	 * @param jqPasteDiv
	 */
	Aloha.PastePlugin.GenericPasteHandler.transformFormattings = function(jqPasteDiv) {
	 ...
	 * @param jqPasteDiv
	 */
	Aloha.PastePlugin.GenericPasteHandler.removeComments = function(jqPasteDiv) {
		var that = this;
	 ...
	 * @param jqPasteDiv
	 */
	Aloha.PastePlugin.GenericPasteHandler.unwrapTags = function(jqPasteDiv) {
	 ...
	 * @param jqPasteDiv
	 */
	Aloha.PastePlugin.GenericPasteHandler.removeStyles = function(jqPasteDiv) {
	 ...
	 * @param jqPasteDiv
	 */
	Aloha.PastePlugin.GenericPasteHandler.removeNamespacedElements = function(jqPasteDiv) {
		// get all elements
		jqPasteDiv.find('*').each(function() {
