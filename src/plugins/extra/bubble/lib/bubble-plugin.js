...
(function() {
  ...
  define(['aloha', 'jquery', 'aloha/plugin', './bubble', './link', './figure', './title-figcaption'], function(Aloha, jQuery, Plugin, Bubbler, linkConfig, figureConfig, figcaptionConfig) {
    ...
    _ref = [linkConfig, figureConfig, figcaptionConfig];
