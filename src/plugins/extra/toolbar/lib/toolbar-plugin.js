...
(function() {
  ...
  define(["aloha", "aloha/plugin", "ui/ui", "i18n!format/nls/i18n", "i18n!aloha/nls/i18n", "PubSub", "ui/scopes", "css!toolbar/css/toolbar.css"], function(Aloha, Plugin, Ui, i18n, i18nCore, PubSub, Scopes) {
    ...
    */
    ...
    return Plugin.create("toolbar", {
      init: function() {
        var changeHeading, headings, plugin, squirreledEditable;
        plugin = this;
        ...
        Ui.adopt = function(slot, type, settings) {
          var $buttons, $placeholder, Type, component;
