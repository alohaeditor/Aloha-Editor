...
(function() {
  ...
  toolbarSettings = ['bold', 'italic', 'underline', '', 'insertLink', 'insertImage', 'insertFigure', '', 'orderedList', 'unorderedList', 'outdentList', 'indentList', 'createTable'];
  ...
  define(["aloha", "aloha/plugin", "ui/ui", 'ribbon/ribbon-plugin', '../../appmenu/appmenu', "i18n!format/nls/i18n", "i18n!aloha/nls/i18n", "aloha/console", "css!toolbar/css/toolbar.css"], function(Aloha, Plugin, Ui, Ribbon, appmenu, i18n, i18nCore) {
    ...
    */
    ...
    return Plugin.create("toolbar", {
      init: function() {
        var applyHeading, h, headingButtons, headingsButton, item, labels, menu, menuLookup, menubar, order, recurse, subMenuItems, tab, toolbar, toolbarLookup, _i, _j, _len, _len1;
        ...
        Ui.adopt = function(slot, type, settings) {
          ...
          if (slot in menuLookup && slot in toolbarLookup) {
            ...
            item.el[0].element = item.el;
            item2.el[0].element = item2.el;
        ...
        return Aloha.bind("aloha-selection-changed", function(event, rangeObject) {
          var $el, i, isActive, _k, _len2, _results;
