...
*/
define(
['aloha', 'aloha/jquery', 'paste/abstractpastehandler'],
function(Aloha, jQuery, AbstractPasteHandler) {
	"use strict";

	var WordPasteHandler = AbstractPasteHandler.extend({
		/**
