...
var alltests = {
		...
		},
		{
			...
			execResult: '<p><b>before <i>table[]</i></b></p><div class="aloha-table-wrapper" contenteditable="false"></div><p>after table</p>'
		},
...
//		},
		...
		*/
		{	exclude: 'msie',	
			...
			execResult: '<dl class="alohafocus"><dt>foo[]bar<dd>baz</dl>'
		},
		{	include: 'msie',	
			start: '<dl><dt>foo[<dt>]bar<dd>baz</dl>',
		...
		*/
		...
		{	exclude: 'msie',
			start: '<dl><dt>foo<dd>bar[<dd>]baz</dl>',
			execResult: '<dl class="alohafocus"><dt>foo<dd>bar[]baz</dl>'
		},
		{	include: 'msie',
